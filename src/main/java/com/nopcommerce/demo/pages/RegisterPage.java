...
public class RegisterPage extends Utility {
    ...
    public String getRegisterHeading() {
        ...
        CustomListeners.test.log(Status.PASS, "Get registration heading " + registerHeading);
    ...
    public void clickOnRegisterButton() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on registration button " + registerButton);
    }

    public String getFirstNameError() {
        Reporter.log("Get First Name Error " + firstNameError.toString());
        CustomListeners.test.log(Status.PASS, "Get First Name Error " + firstNameError);
        return getTextFromElement(firstNameError);
    }

    public String getLastNameError() {
        Reporter.log("Get Last Name Error " + lastNameError.toString());
        CustomListeners.test.log(Status.PASS, "Get Last Name Error " + lastNameError);
        return getTextFromElement(lastNameError);
    }

    public String getEmailError() {
        Reporter.log("Get email error " + emailError.toString());
        CustomListeners.test.log(Status.PASS, "Get email error  " + emailError);
        return getTextFromElement(emailError);
    }

    public String getConfirmPasswordError() {
        Reporter.log("Get confirm password error " + confirmPasswordError.toString());
        CustomListeners.test.log(Status.PASS, "Get confirm password error " + confirmPasswordError);
    ...
    public void clickOnMaleRadio() {
        ...
        CustomListeners.test.log(Status.PASS, "Click on male radio button " + maleRadio);
    }

    public void clickOnFemaleRadio() {
        clickOnElement(femaleRadio);
        Reporter.log("Click on female radio button " + femaleRadio.toString());
        CustomListeners.test.log(Status.PASS, "Click on female radio button " + femaleRadio);
    }
